<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPersonnelVerified.aspx.cs" Inherits="Salary_Calculator_frmPersonnelVerified" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="250px" Width="650px">
            ...
            <br />
            <asp:Button ID="btnViewPersonnel" runat="server" PostBackUrl="~/Salary Calculator/frmViewPersonnel.aspx" Text="View Personnel" />
        </asp:Panel>
    </form>
</body>
</html>
